        ...
        ?>
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Entreprise/</span> Nouvelle entreprise</h4>
                ...
                <div class="col-xl">
                  <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center">
                      <h5 class="mb-0"></h5>
                      <small class="text-muted float-end">Renseignements sur l'entreprise</small>
                    </div>
                    <div class="card-body">
                      <form>
                        <div class="mb-3">
                          <label class="form-label" for="basic-default-fullname">Nom de l'entreprise</label>
                          <input type="text" class="form-control" id="basic-default-fullname" placeholder="ex ujuzibrain">
                        </div>
                        <div class="mb-3">
                          <label class="form-label" for="basic-default-fullname">Identifient National</label>
                          <input type="text" class="form-control" id="basic-default-fullname" placeholder="ex 63RU3I3I3IT4">
                        </div>
                        <div class="mb-3">
