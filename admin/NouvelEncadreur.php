                ...
                <div class="col-xl">
                  <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center">
                      <h5 class="mb-0"></h5>
                      <small class="text-muted float-end">Renseignements sur l'encadreur</small>
                    </div>
                    <div class="card-body">
                      <form>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                          ...
                          <div class="input-group input-group-merge">
                            <input type="text" id="basic-default-email" class="form-control" placeholder="gmail.com" aria-label="..." aria-describedby="basic-default-email2">
